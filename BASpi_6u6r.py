...
class Controller(polyinterface.Controller):
    ...
    def discover(self, *args, **kwargs):
        if self.ipaddress is not None:
            ...
            self.setDriver('GV2', input_tre, force=True)
    ...
    def check_params(self):
        ...
        default_baspi6u6r_ip = None
               
        if 'baspi6u6r_ip' in self.polyConfig['customParams']:
            self.ipaddress = self.polyConfig['customParams']['baspi6u6r_ip']
        else:
            self.ipaddress = default_baspi6u6r_ip
            LOGGER.error(
        ...
        self.addCustomParam({'baspi6u6r_ip': self.ipaddress, 'debug_enable': self.debug_enable})
        ...
        if self.ipaddress == default_baspi6u6r_ip:
    ...
    drivers = [
        ...
        {'driver': 'GV3', 'value': 1, 'uom': 3},
        {'driver': 'GV4', 'value': 1, 'uom': 73},
        {'driver': 'GV5', 'value': 1, 'uom': 7},
