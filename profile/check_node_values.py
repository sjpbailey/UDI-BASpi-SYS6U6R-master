...
editor_tree = ET.parse('/Users/stevenbailey/UDI Development/Nodeservers/UDI-BASpi-SYS6U6R-master/profile/editor/editors.xml')
...
nls = {}
with open('/Users/stevenbailey/UDI Development/Nodeservers/UDI-BASpi-SYS6U6R-master/profile/nls/en_us.txt') as fp:
    for line in fp:
        line = line.rstrip()
        if line != "" and line[0] != '#':
            pair = line.split(" = ")
...
node_tree = ET.parse('/Users/stevenbailey/UDI Development/Nodeservers/UDI-BASpi-SYS6U6R-master/profile/nodedef/nodedefs.xml')
